...
sap.ui.define([
		...
		"phoenix/zfr_nb_trnsfrdata_18/model/formatter"
	], function (
		BaseController,
		JSONModel,
		History,
		...
		return BaseController.extend("phoenix.zfr_nb_trnsfrdata_18.controller.Object", {
			...
			_onBindingChange : function () {
				...
				this.addHistoryEntry({
					...
					intent: "#TransferDatabetweenViews-display&/WorkerSet/" + sObjectId
				});
